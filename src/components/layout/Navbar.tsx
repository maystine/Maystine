      ...
      <div style={{
        ...
        <div className={`navbar-links${menuOpen ? ' navbar-links-open' : ''}`}>
          ...
          >
            ...
            <span style={{ color: 'var(--text)' }}>YouTube</span>
          </a>
          ...
          >
            ...
            <span style={{ color: 'var(--text)' }}>Twitch</span>
          </a>
          ...
          >
            ...
            <span style={{ color: 'var(--text)' }}>Twitter</span>
          </a>
          ...
          >
            ...
            <span style={{ color: 'var(--text)' }}>Discord</span>
          </a>
          </div>
        </div>
      </div>
